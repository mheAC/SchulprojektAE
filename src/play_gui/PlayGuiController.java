			...
			if(cells.isEmpty()){
				...
				while(cellsIterator.hasNext()){
					...
					if(cell.isInColoumnWith(mainWindow.getActiveCell()))
						tmpCell.drawLine(Direction.VERTICAL, tmpCell, mainWindow.getGameGrid().getLoghandler());
					else if(cell.isInRowWith(mainWindow.getActiveCell()))
						tmpCell.drawLine(Direction.HORIZONTAL, tmpCell, mainWindow.getGameGrid().getLoghandler());
				}	
			}
		}
	}
